; This program resides in the first sector of the flash memory
;
; Load sectors 2 to 31 (not 0) into RAM, starting at address 0200h.
; After that, re-call part of the boot loader (serboot.a51) to load sector 1 at address 0100h (overwriting this program), then start executing at 0100h

; LOAD_ADDRESS must be on a 256 byte boundary
...
; Address to start reading data into is LOAD_ADDRESS+256
	inc r0
